...
const Affine = () => {
    ...
    let encrypt = encode(plainText, {a:keyA, b:keyB})
    let decrypt = decode(encrypt, {a:keyA, b:keyB})
                ...
                <div className="convert__content">
                    <div className="field field-number field--first">
                        ...
                        <div className="field-number__field">
                            <button className='field-number__down' onClick={() => setKeyA(keyA - 2 === 13 ? keyA - 4 : keyA - 2)}>-</button>
                            <div className="field-number__value">{keyA}</div>
                            <button className='field-number__up' onClick={() => setKeyA(keyA + 2 === 13 ? keyA + 4 : keyA + 2)}>+</button>
                        </div>
                    </div>
                    ...
                    <div className="field field-number field--second">
                        ...
                        <div className="field-number__field">
                            <button className='field-number__down' onClick={() => setKeyB(keyB - 1)}>-</button>
                            <div className="field-number__value">{keyB}</div>
                            <button className='field-number__up' onClick={() => setKeyB(keyB + 1)}>+</button>
                        </div>
                    </div>
                    
                    <div className="btn-container">
                            <button onClick={() => setCipherText(encrypt)}>Encrypt</button>
                            <button onClick={() => setPlainText(decrypt)}>Decrypt</button>
                    </div>
                </div>
